        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo(base_url() . index_page() . '/inicio');?>">In&iacute;cio <span class="sr-only">(current)</span></a></li>
                    <li><a href="<?php echo(base_url() . index_page() . '/aluno/cursos');?>">Cursos</a></li>
                    <!--
                    <li class="dropdown">
