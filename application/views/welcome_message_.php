...
<body class="hold-transition lockscreen">
    ...
    <!-- User name -->
    <div class="lockscreen-name">Projeto Curso em Libras</div>

    <!-- START LOCK SCREEN ITEM -->
    <div class="lockscreen-item">
        <p>Projeto de conclusão do curso de Análise e Desenvolvimento de Sistemas da FATEC Ipiranga</p>
        <p>São Paulo, 2018-2019</p>
    </div>
    <!-- /.lockscreen-item -->
