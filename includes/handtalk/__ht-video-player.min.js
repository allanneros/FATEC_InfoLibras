!(function (t) {
      ...
      f = (t.exports = function (t, e, n, f, p) {
        ...
        if (i(y)) {
          for (d = s(t.length); d > b; b++)
            if ((g = e ? m(a((h = t[b]))[0], h[1]) : m(t[b])) === c || g === l)
              return g;
        } else
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, v, g, y, m) {
      ...
      if (
        (F &&
          (j = f(F.call(new t()))) !== Object.prototype &&
          j.next &&
          (l(j, C, !0), r || s(j, p) || a(j, p, h)),
        k &&
          S &&
          "values" !== S.name &&
          ((P = !0),
        ...
        function e(t, n) {
          ...
          return (
            ...
            (i.toggleActive = function (t) {
              (i.active = void 0 !== t ? t : !i.active),
                (i.elem.style.display = i.active ? "block" : "none");
            }),
            (t.loadingDisplay = i),
            i
          );
          ...
          a(e, [
            {
              ...
              value: function () {
                var t = {
                  innerHTML:
                    '<div class="vjs-ht-loading-display-content"></div>',
                };
                return (
                  (this.elem = s(
                  ...
                  (this.elem.className = "vjs-ht-loading-display"),
                  this.elem
                );
              },
            },
  ...
  function (t, e, n) {
    ...
    var o = n(75),
      ...
      f = r(l);
    n(169),
      (window.Youtube = i.default),
      (window.Vimeo = s.default),
      (window.Sambatech = c.default),
      (window.HTVideo = f.default);
  },
  function (t, e, n) {
    "use strict";
    function r(t, e) {
    ...
    var u = window.videojs.getComponent("Tech"),
      c = (function (t) {
        function e(t, n) {
          ...
          return (
            l.call(i),
            i.setSrc(i.options_.source, !0),
            i.setTimeout(function () {
              if (i.el_)
                if (((i.el_.parentNode.className += " vjs-yt"), e.isApiReady))
                  i.initYTPlayer();
                else {
                  if (!e.jsInjected) {
                    var t = document.createElement("script");
                    (t.src = "https://www.youtube.com/iframe_api"),
                      (t.onload = e.apiLoaded),
    ...
    (c.jsInjected = !1),
      ...
      (c.apiLoaded = function () {
        YT.ready(function () {
          (c.isApiReady = !0),
            c.apiReadyQueue.forEach(function (t) {
    ...
    var l = function () {
      ...
      (this.getPostUrl = function (t) {
        ...
        (this.setSrc = function (e) {
          if (!e || !e.src) return !1;
          delete t.errorNumber,
            (t.source = e),
            (t.url = c.parseUrl(e.src)),
            t.options_.poster ||
              (t.url.videoId &&
                (t.setPoster(t.getPostUrl(t.url.videoId)),
                t.trigger("posterchange"),
                t.checkHighResPoster())),
            t.options_.autoplay
              ? t.isReady_
                ? t.play()
                : (t.playOnReady = !0)
              : t.activeVideoId !== t.url.videoId &&
                (t.isReady_
                  ? (t.cueVideoById_(t.url.videoId),
                    (t.activeVideoId = t.url.videoId))
                  : (t.cueOnReady = !0));
        }),
        ...
        (this.dispose = function () {
          if (t.ytPlayer)
            t.ytPlayer.stopVideo && t.ytPlayer.stopVideo(),
              t.ytPlayer.destroy && t.ytPlayer.destroy();
          else {
            var e = c.apiReadyQueue.indexOf(t);
            -1 !== e && c.apiReadyQueue.splice(e, 1);
          }
          (t.ytPlayer = null),
            (t.el_.parentNode.className = t.el_.parentNode.className.replace(
              " vjs-yt",
              ""
            )),
            t.el_.parentNode.removeChild(t.el_),
            u.prototype.dispose.call(t);
        }),
        (this.initYTPlayer = function () {
          ...
          if (
            (void 0 !== t.options_.autohide &&
              (e.autohide = t.options_.autohide),
            void 0 !== t.options_.ytControls &&
              (e.controls = t.options_.ytControls),
            void 0 !== t.options_.disablekb &&
              (e.disablekb = t.options_.disablekb),
            void 0 !== t.options_.end && (e.end = t.options_.end),
            void 0 !== t.options_.color && (e.color = t.options_.color),
            e.controls
              ? void 0 !== t.options_.fs && (e.fs = t.options_.fs)
              : (e.fs = 0),
            void 0 !== t.options_.end && (e.end = t.options_.end),
            void 0 !== t.options_.hl
              ? (e.hl = t.options_.hl)
              : void 0 !== t.options_.language &&
                (e.hl = t.options_.language.substr(0, 2)),
            void 0 !== t.options_.iv_load_policy &&
              (e.iv_load_policy = t.options_.iv_load_policy),
            void 0 !== t.options_.list
              ? (e.list = t.options_.list)
              : t.url && void 0 !== t.url.listId && (e.list = t.url.listId),
            void 0 !== t.options_.listType &&
              (e.listType = t.options_.listType),
            void 0 !== t.options_.modestbranding &&
              (e.modestbranding = t.options_.modestbranding),
            void 0 !== t.options_.playlist &&
              (e.playlist = t.options_.playlist),
            void 0 !== t.options_.playsinline &&
              (e.playsinline = t.options_.playsinline),
            void 0 !== t.options_.rel && (e.rel = t.options_.rel),
            void 0 !== t.options_.showinfo &&
              (e.showinfo = t.options_.showinfo),
            void 0 !== t.options_.start && (e.start = t.options_.start),
            void 0 !== t.options_.theme && (e.theme = t.options_.theme),
            void 0 !== t.options_.customVars)
          ) {
          ...
          (t.activeVideoId = t.url ? t.url.videoId : null),
            (t.activeList = e.list),
            (t.ytPlayer = new YT.Player(t.options_.techId, {
        ...
        (this.play = function () {
          ...
          (t.wasPausedBeforeSeek = !1),
            t.isReady_
              ? (t.url.listId &&
                  (t.activeList === t.url.listId
                    ? t.ytPlayer.playVideo()
                    : (t.ytPlayer.loadPlaylist(t.url.listId),
                      (t.activeList = t.url.listId))),
                t.activeVideoId === t.url.videoId
                  ? t.ytPlayer.playVideo()
                  : (t.loadVideoById_(t.url.videoId),
                    (t.activeVideoId = t.url.videoId)))
              : (t.trigger("waiting"), (t.playOnReady = !0));
        }),
        (this.togglePausedClass = function (e) {
          e
            ? t.el().parentNode.classList.add("vjs-youtube-paused")
            : t.el().parentNode.classList.remove("vjs-youtube-paused");
        }),
        (this.buffered = function () {
          if (!t.ytPlayer || !t.ytPlayer.getVideoLoadedFraction)
            return window.videojs.createTimeRange();
          var e =
            t.ytPlayer.getVideoLoadedFraction() * t.ytPlayer.getDuration();
          return window.videojs.createTimeRange(0, e);
        }),
        (this.loadVideoById_ = function (e) {
          var n = { videoId: e };
          t.options_.start && (n.startSeconds = t.options_.start),
            t.options_.end && (n.endEnd = t.options_.end),
            t.ytPlayer.loadVideoById(n);
        }),
        (this.cueVideoById_ = function (e) {
          var n = { videoId: e };
          t.options_.start && (n.startSeconds = t.options_.start),
            t.options_.end && (n.endEnd = t.options_.end),
            t.ytPlayer.cueVideoById(n);
        }),
        (this.src = function (e) {
          return e && t.setSrc({ src: e }), t.source;
        }),
        (this.currentSrc = function () {
          return t.source && t.source.src;
        }),
        (this.onPlayerReady = function () {
          t.options_.muted && t.ytPlayer.mute(),
            t.ytPlayer.getAvailablePlaybackRates().length > 1 &&
              (t.featuresPlaybackRate = !0),
            (t.playerReady_ = !0),
            t.triggerReady(),
            t.playOnReady
              ? t.play()
        ...
        (this.paused = function () {
          return (
            !t.ytPlayer ||
            (t.lastState !== YT.PlayerState.PLAYING &&
              t.lastState !== YT.PlayerState.BUFFERING)
          );
        }),
        ...
        (this.setCurrentTime = function (e) {
          t.lastState === YT.PlayerState.PAUSED &&
            (t.timeBeforeSeek = t.currentTime()),
            t.isSeeking || (t.wasPausedBeforeSeek = t.paused()),
            t.ytPlayer.seekTo(e, !0),
            t.trigger("timeupdate"),
            t.trigger("seeking"),
            (t.isSeeking = !0),
            t.lastState === YT.PlayerState.PAUSED &&
              t.timeBeforeSeek !== e &&
              (clearInterval(t.checkSeekedInPauseInterval),
              (t.checkSeekedInPauseInterval = setInterval(function () {
                t.lastState === YT.PlayerState.PAUSED && t.isSeeking
                  ? t.currentTime() !== t.timeBeforeSeek &&
                    (t.trigger("timeupdate"), t.onSeeked())
                  : clearInterval(t.checkSeekedInPauseInterval);
              }, 250)));
        }),
        ...
        (this.seekable = function () {
          return t.ytPlayer
            ? window.videojs.createTimeRange(0, t.ytPlayer.getDuration())
            : window.videojs.createTimeRange();
        }),
        (this.muted = function () {
        ...
        (this.setMuted = function (e) {
          if (!t.ytPlayer) return !1;
          t.muted(!0),
            e ? t.ytPlayer.mute() : t.ytPlayer.unMute(),
        ...
        (this.onPlayerStateChange = function (e) {
          var n = e.data;
          if (
            (t.ytPlayer.unloadModule("captions"),
            t.ytPlayer.unloadModule("cc"),
            n !== t.lastState && !t.errorNumber)
          ) {
            switch (n) {
              default:
                break;
              ...
              case YT.PlayerState.PLAYING:
                t.lastState !== YT.PlayerState.PLAYING &&
                  t.togglePausedClass(!1),
                  t.trigger("timeupdate"),
                  t.trigger("durationchange"),
                  t.trigger("playing"),
                  t.trigger("play"),
                  t.isSeeking && t.onSeeked();
                break;
              case YT.PlayerState.PAUSED:
                t.togglePausedClass(!0),
                  t.trigger("canplay"),
                  t.isSeeking ? t.onSeeked() : t.trigger("pause");
                break;
        ...
        (this.error = function () {
          ...
          switch (t.errorNumber) {
            ...
            case 2:
            case 100:
              return { code: e, message: "Unable to find the video" };
            case 101:
            case 150:
              return {
                code: e,
        ...
        (this.onSeeked = function () {
          clearInterval(t.checkSeekedInPauseInterval),
            (t.isSeeking = !1),
            t.wasPausedBeforeSeek && t.pause(),
            t.trigger("seeked");
        }),
        (this.onPlayerPlaybackQualityChange = function () {}),
        (this.onPlayerPlaybackRateChange = function () {
          t.trigger("ratechange");
        }),
    ...
    window.videojs.registerTech("Youtube", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
    (e = t.exports = n(23)(void 0)),
      e.push([
        t.i,
        ".vjs-yt .vjs-poster{background-size:cover}.vjs-youtube-paused .vjs-sign-language-track-display .vjs-hugo-display{opacity:0}",
        "",
      ]);
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
        ...
        function e(t, n) {
          ...
          return (
            ...
            (i.initVimeoPlayer = function () {
              ...
              i.options_.autoplay && (t.autoplay = !0),
                i.options_.height && (t.height = i.options_.height),
                i.options_.width && (t.width = i.options_.width),
                i.options_.maxheight && (t.maxheight = i.options_.maxheight),
                i.options_.maxwidth && (t.maxwidth = i.options_.maxwidth),
                i.options_.loop && (t.loop = i.options_.loop),
                i.options_.color &&
                  (t.color = i.options_.color.replace(/^#/, "")),
                (i._player = new u.default(i.options_.techId, t)),
                i.initVimeoState(),
                i._player.on("progress", function (t) {
                  i._vimeoState.progress.duration !== t.duration &&
                    i.trigger("durationchange");
                }),
    ...
    (l.isSupported = function () {
      ...
      window.videojs.registerTech("Vimeo", l),
      (e.default = l),
      (t.exports = e.default);
  },
  function (t, e, n) {
    ...
    (function (t) {
      ...
      function o(t, e) {
        return 0 === t.indexOf(e.toLowerCase())
          ? t
          : "" + e.toLowerCase() + t.substr(0, 1).toUpperCase() + t.substr(1);
      }
      function i(t) {
      ...
      function g(t) {
        ...
        return new P.default(function (n, r) {
          ...
          var o =
            "https://vimeo.com/api/oembed.json?url=" + encodeURIComponent(t);
          for (var i in e)
            e.hasOwnProperty(i) &&
              (o += "&" + i + "=" + encodeURIComponent(e[i]));
          var a =
          ...
          a.open("GET", o, !0),
            (a.onload = function () {
              if (404 === a.status)
                return void r(new Error("“" + t + "” was not found."));
              if (403 === a.status)
                return void r(new Error("“" + t + "” is not embeddable."));
              try {
          ...
          (c(function (t, e) {
            !(function (t) {
              ...
              function i(t, e) {
                ...
                if (e != e || 0 === e) for (m = t.length; m-- && !w(t[m], e); );
                else m = t.indexOf(e);
                return -1 < m;
              }
              function a(t) {
              ...
              void 0 === G.default &&
                (t.WeakMap = e(
                  { delete: r, clear: l, get: o, has: s, set: u },
                  !0
                )),
                (void 0 !== V.default &&
                  "function" == typeof new V.default().values &&
                  new V.default().values().next) ||
                  (t.Map = e({
                    delete: r,
                    has: s,
                    get: o,
                ...
                (void 0 !== D.default &&
                  "function" == typeof new D.default().values &&
                  new D.default().values().next) ||
                  (t.Set = e({
                    has: a,
                    add: c,
                    delete: r,
                ...
                void 0 === W.default &&
                  (t.WeakSet = e({ delete: r, add: c, clear: l, has: a }, !0));
            })(void 0 !== J ? J : window);
          }),
          c(function (t) {
            var e =
              "function" == typeof M.default &&
              "symbol" === (0, L.default)(T.default)
                ? function (t) {
                ...
                : function (t) {
                    return t &&
                      "function" == typeof M.default &&
                      t.constructor === M.default &&
                      t !== M.default.prototype
                      ? "symbol"
                      : void 0 === t
                      ? "undefined"
                      : (0, L.default)(t);
            ...
            !(function (e, n, r) {
              ...
              function o(t, e, r) {
                ...
                try {
                  !1 === e
                    ? r.reject(t.msg)
                    : ((o = !0 === e ? t.msg : e.call(void 0, t.msg)),
                      o === r.promise
        ...
        tt = (function () {
          function t(e) {
            ...
            return (
              ...
              "IFRAME" === this.element.nodeName && b(this, "ping"),
              this
            );
          }
          return (
                ...
                value: function (t) {
                  ...
                  return new U(function (r, o) {
                    return e
                      .ready()
                      .then(function () {
                        l(e, t, { resolve: r, reject: o }), b(e, t, n);
                      })
                      .catch(function (t) {
                        o(t);
                      });
                  ...
                  return new U(function (n, r) {
                    return (
                      ...
                      e.ready().then(function () {
                        l(e, t, { resolve: n, reject: r }), b(e, t);
                      })
                    );
                  });
                },
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return U.resolve(e).then(function (e) {
                    if (((t = o(t, "set")), void 0 === e || null === e))
                      throw new TypeError("There must be a value to set.");
                    return n.ready().then(function () {
                      return new U(function (r, o) {
                        l(n, t, { resolve: r, reject: o }), b(n, t, e);
                      });
                    });
                  });
                },
        ...
        ((function () {
          var t =
            ...
            n = function (t) {
              "console" in window &&
                console.error &&
                console.error("There was an error creating an embed: " + t);
            };
              ...
              if (s(e.origin) && e.data && "spacechange" === e.data.event)
                for (
                  ...
                  if (n[r].contentWindow === e.source) {
                    ...
                    o &&
                      -1 !== o.className.indexOf("vimeo-space") &&
                      (o.style.paddingBottom = e.data.data[0].bottom + "px");
                    break;
                  }
            };
          window.addEventListener
  ...
  function (t, e, n) {
    ...
    var i = n(64),
      ...
      u = r(s),
      c =
        "function" == typeof u.default && "symbol" === o(a.default)
          ? function (t) {
  ...
  function (t, e, n) {
    ...
    var r =
      ...
      q = function (t, e) {
        w(t);
        for (var n, r = m((e = j(e))), o = 0, i = r.length; i > o; )
          U(t, (n = r[o++]), e[n]);
        return t;
      },
      Z = function (t, e) {
      ...
      K = function (t) {
        ...
        return (
          !(this === G && i(V, t) && !i(I, t)) &&
          (!(e || !i(this, t) || !i(V, t) || (i(this, W) && this[W][t])) || e)
        );
      },
      _ = function (t, e) {
        if (((t = j(t)), (e = x(e, !0)), t !== G || !i(V, e) || i(I, e))) {
          var n = T(t, e);
          return (
            !n || !i(V, e) || (i(t, W) && t[W][e]) || (n.enumerable = !0), n
          );
        }
      },
      $ = function (t) {
        for (var e, n = L(j(t)), r = [], o = 0; n.length > o; )
          i(V, (e = n[o++])) || e == W || e == c || r.push(e);
        return r;
      },
      tt = function (t) {
        for (
          var e, n = t === G, r = L(n ? I : j(t)), o = [], a = 0;
          r.length > a;
    ...
    H ||
      ((A = function () {
        ...
        return a && Q && X(G, t, { configurable: !0, set: e }), Y(t);
      }),
      ...
      (n(31).f = K),
      (n(53).f = tt),
      a && !n(26) && u(G, "propertyIsEnumerable", K, !0),
      (v.f = function (t) {
        return Y(h(t));
      })),
    ...
    s(s.S + s.F * !H, "Symbol", {
      ...
      A.prototype[B] || n(7)(A.prototype, B, A.prototype.valueOf),
      p(A, "Symbol"),
      p(Math, "Math", !0),
      p(o.JSON, "JSON", !0);
  },
  ...
  function (t, e, n) {
    ...
    var c = window.videojs.getComponent("Tech"),
      l = (function (t) {
        function e(t, n) {
          ...
          return (
            (i.applyTheme = function () {
              i.el().parentNode.classList.add("vjs-sambatech-theme"),
                i.removeExtraComponents();
            }),
            (i.removeExtraComponents = function () {
              window.videojs(i.options_.playerId).ready(function () {
                this.controlBar.removeChild(this.controlBar.subsCapsButton),
                  this.removeChild(this.bigPlayButton);
              });
            }),
            (i.sambaPlayer = null),
            (i.state = {
                    ...
                    i.sambaPlayer.getStatus(function (t) {
                      ...
                      (i.statusInterval = setInterval(function () {
                        i.sambaPlayer.getStatus(function (t) {
                          ...
                          (i.state.buffer = n),
                            (i.state.bufferEnd = r),
                            (i.state.bufferStart = o),
                            (i.state.volume = a / 100),
                            (i.state.muted = s),
            ...
            (i.setMuted = function () {
              i.state.muted ? i.sambaPlayer.unmute() : i.sambaPlayer.mute(),
                (i.state.muted = !i.state.muted),
                i.trigger("volumechange");
            }),
            (i.volume = function () {
              ...
              if (i.el_)
                if (e.isSambaPlayerReady) i.initSambatechPlayer();
                  ...
                  if (!e.jsInjected) {
                    ...
                    (t.src =
                      "https://player.sambatech.com.br/v3/samba.player.api.js"),
                      (t.onload = e.sambaPlayerInjected),
                      u.default.body.appendChild(t),
                      (e.jsInjected = !0);
                  }
    ...
    (l.jsInjected = !1),
      ...
      (l.isSambaPlayerReady = !1),
      (l.sambaPlayerInjectedQueue = []),
      (l.sambaPlayerInjected = function () {
        (l.isSambaPlayerReady = !0),
          l.sambaPlayerInjectedQueue.forEach(function (t) {
      ...
      window.videojs.registerTech("Sambatech", l),
      (e.default = l),
      (t.exports = e.default);
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
        ...
        function e(t) {
          ...
          return (
            ...
            (n.auth = function () {
              return (
                n._authPromise ||
                  (n._authPromise = new Promise(function (t, r) {
                    var o = new XMLHttpRequest();
                    (n.uid = f.default.get("ht-video-uid")),
                      o.open(
                        "GET",
                        "https://translation.handtalk.me/web/auth?token=" +
                          n.hugo.token
                      ),
                      o.setRequestHeader("Version", "3"),
                      o.setRequestHeader("Access-Control-Allow-Origin", "*"),
                      n.uid && o.setRequestHeader("UID", n.uid);
                    var i = function () {
                      ...
                      return 200 !== o.status
                        ? ((n.authFailed = !0),
                          r(u || e.authGenericErrorMessage))
                        : (!n.uid &&
                            s &&
                            f.default.set("ht-video-uid", s, { expires: 3650 }),
                          t(a));
                    };
            ...
            (n.createAccessibilePlayer = function (t, e, r, o, i) {
              ...
              a.on(a, "ready", function () {
                a.addClass("video-js"),
                  a.controls(!0),
                  a.src({ type: "video/" + r, src: e });
                var t = null;
                !i && o && (t = n.createTextTrack(a, o)),
                  a.on(a, "ready", function () {
            ...
            (n.createTextTrack = function (t, e) {
              ...
              return (
                n.subtitleManager.getCuesFromPlainText(e).map(function (t) {
                  return r.addCue(t);
                }),
                r
              );
            ...
            (n.makeVideojsAccessibile = function (t) {
              n.addAccessibilityComponents(
                t,
                n.subtitleManager.getValidTextTrack(t)
              );
            }),
            (n.hugo = t.hugo),
            (n.authEnabled = t.authEnabled),
            (n.subtitleManager = new d.default()),
            n
          );
        }
        return (
          ...
          s(e, [
            {
              ...
              value: function (t, e) {
                t.signLanguageTrackDisplay ||
                  ((this.videosInPage += 1),
                  (t.internalId = this.videosInPage),
                  t.addClass("ht-skip"),
                  t.addClass("ht-vjs-global-skin"),
                  t.controlBar.addChild("SignLanguageButton"),
                  t.controlBar.fullscreenToggle &&
                    t.controlBar
                      .el()
                      .insertBefore(
                        t.signLanguageButton.el(),
                        t.controlBar.fullscreenToggle.el()
                      ),
                  t.addChild("SignLanguageBigPlayButton"),
                  t.addChild("LoadingDisplay"),
                  t.addChild("SignLanguageTrackDisplay", {
                    hugo: this.hugo,
                    htVideo: this,
                    textTrack: e,
                  }));
    ...
    (h.authGenericErrorMessage =
      "Opa! Um problema ocorreu :/ aguarde um instante e recarregue a página."),
      (e.default = h),
      (t.exports = e.default);
  },
  function (t, e, n) {
  ...
  function (t, e, n) {
        ...
        function e(t, n) {
          ...
          return (
            ...
            (i.toggleActive = function (t) {
              i.locked ||
                ((i.active = void 0 !== t ? t : !i.active),
                i.player().signLanguageTrackDisplay.toggleActive(i.active),
                i.active
                  ? i.addClass("ht-accessibility-active")
                  : i.removeClass("ht-accessibility-active"));
            }),
            (t.signLanguageButton = i),
            i
          );
        }
        return (
              ...
              value: function () {
                return (
                  s(
                    ...
                    "buildCSSClass",
                    this
                  ).call(this) + " ht-accessibility-icon"
                );
              },
            },
          ]),
    ...
    window.videojs.registerComponent("SignLanguageButton", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
          ...
          a(e, [
            {
              ...
              value: function (t) {
                this.locked ||
                  ...
                  this.player().signLanguageButton.toggleActive(!0));
              },
            },
            {
              key: "createEl",
              value: function () {
                ...
                return (
                  (t.className = "vjs-ht-accessibility-big-play-button"), t
                );
              },
            },
          ]),
    ...
    window.videojs.registerComponent("SignLanguageBigPlayButton", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
    ...
    var u = window.videojs.getComponent("Component"),
      c = (function (t) {
        function e(t, n) {
          ...
          return (
            l.call(a),
            (t.signLanguageTrackDisplay = a),
            (a.htVideo = void 0 !== n.htVideo ? n.htVideo : null),
            (a.textTrack = void 0 !== n.textTrack ? n.textTrack : null),
            t.tech({ IWillNotUseThisInPlugins: !0 }).applyTheme &&
              t.tech({ IWillNotUseThisInPlugins: !0 }).applyTheme(),
            a.textTrack && (a.textTrack.mode = "showing"),
            a.textTrack && 0 !== a.textTrack.length
              ? ((t.hugoLoadingDisplay = a.addChild("HugoLoadingDisplay", {
                  hugo: n.hugo,
                })),
                (t.hugoDisplay = a.addChild("HugoDisplay", { hugo: n.hugo })),
                (t.errorSplash = a.addChild("ErrorSplash")),
                a.toggleActive(!1),
                a.htVideo.on("hugoViewChanged", a.onHugoChangedView),
                a.htVideo.on("externalError", a.onError),
                a.htVideo.error && a.onError(),
                "function" == typeof a.textTrack.on
                  ? a.textTrack.on("cuechange", a.onCueChanged)
                  : (a.textTrack.oncuechange = a.onCueChanged),
                a.on(t, "hugoready", a.onHugoReady),
                a.on(t, "error", a.onError),
                a.on(t, "loadeddata", a.resize),
                window.addEventListener("resize", a.onWindowResize),
                a.resize(),
                a)
              : ((i = a.onError()), o(a, i))
          );
    ...
    (c.acceptedLanguages = ["pt", "br", "pt-br", "pt_br", "ptBr"]),
      (c.hugoHorizontalFactor = 0.625),
      (c.percentageInPotrait = 0.35),
      (c.percentageInLandscape = 0.65),
      (c.widthCutOutSmall = 700),
      (c.widthCutOutXSmall = 450),
      (c.slidingWindowSize = 6);
    var l = function () {
      var t = this;
      (this.active = !1),
        (this.textTrack = null),
        ...
        (this.onError = function () {
          (t.hasError = !0),
            t.player().signLanguageButton.toggleActive(!1),
            t.lockButtons();
        }),
        (this.lockButtons = function () {
          t.player().signLanguageButton.lock(),
            t.player().signLanguageBigPlayButton.lock();
        }),
        (this.onHugoChangedView = function (e) {
          t.active &&
            e.internalId !== t.player().internalId &&
            (t.resize(),
            t.player().signLanguageButton.toggleActive(!1),
            t.player().pause(),
        ...
        (this.prepareNextCues = function (e) {
          for (
            var n = t.getNextCues(e, c.slidingWindowSize), r = n.length, o = 0;
            o < r;
            o += 1
          )
            t.player().hugoDisplay.prepare(n[o]);
        }),
        (this.resize = function () {
          var e = t.player().el().offsetWidth < c.widthCutOutSmall,
            n = t.player().el().offsetWidth < c.widthCutOutXSmall;
          e && !n
            ? (t.player().el().classList.remove("ht-vjs-xsmall"),
              t.player().el().classList.add("ht-vjs-small"))
            : n
            ? (t.player().el().classList.remove("ht-vjs-small"),
              t.player().el().classList.add("ht-vjs-xsmall"))
            : (t.player().el().classList.remove("ht-vjs-small"),
              t.player().el().classList.remove("ht-vjs-xsmall"));
          var r =
              t.player().el().offsetWidth > t.player().el().offsetHeight
                ? c.percentageInLandscape
                : c.percentageInPotrait,
        ...
        (this.toggleActive = function (e) {
          (t.active = void 0 !== e ? e : !t.active),
            t.toggleView(t.active),
            t.active && t.player().pause(),
            t.player().hugoLoadingDisplay &&
              t.player().hugoLoadingDisplay.toggleActive(t.active),
            t.htVideo.authEnabled
              ? t.toggleActiveWithAuth()
              : (t.player().hugoDisplay &&
                  t.player().hugoDisplay.toggleActive(t.active),
                t.active && t.htVideo.emit("hugoViewChanged", t.player()));
        }),
        (this.toggleActiveWithAuth = function () {
          t.active
            ? (t.htVideo
                ...
                .then(function () {
                  t.player().hugoDisplay &&
                    t.player().hugoDisplay.toggleActive(!0);
                })
                .catch(function (e) {
                  t.player().hugoLoadingDisplay &&
                    t.player().hugoLoadingDisplay.toggleActive(!1),
                    t.player().errorSplash.setMessage(e),
                    t.player().errorSplash.toggleActive(!0);
                }),
              t.htVideo.emit("hugoViewChanged", t.player()))
            : t.player().hugoDisplay && t.player().hugoDisplay.toggleActive(!1);
        }),
        (this.toggleView = function (e) {
          e ? t.show() : t.hide();
        });
    };
    window.videojs.registerComponent("SignLanguageTrackDisplay", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
    ...
    var a = (function () {
      ...
      c = (function (t) {
        function e(t, n) {
          ...
          return (
            (i.active = !1),
            (i.onDownloadDependenciesProgress = function () {
              i.active && i.show();
            }),
            ...
            (i.toggleActive = function (t) {
              (i.active = void 0 !== t ? t : !i.active),
                i.active ? i.show() : i.hide();
            }),
            n.hugo.on(
              "downloadDependenciesProgress",
              i.onDownloadDependenciesProgress
            ),
            i.on(t, "hugoready", i.onHugoReady),
            i
          );
        }
        return (
    ...
    window.videojs.registerComponent("HugoLoadingDisplay", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
      ...
      c = (function (t) {
        function e(t, n) {
          ...
          return (
            ...
            (i.hugoLoaded = !1),
            (i.requestList = {}),
            (i.onPlayerResume = function () {
              i.active && !i.hugoLoaded && i.player().pause();
            }),
            (i.onHugoLoaded = function () {
              (i.hugoLoaded = !0),
                i.active &&
                  (i.player().trigger("hugoready"),
                  i.player().play(),
                  i.el().appendChild(i.hugo.elem));
            }),
            ...
            (i.onHugoError = function () {
              i.player().signLanguageTrackDisplay.htVideo.emit(
                "errorOnLoadHugo"
              );
            }),
            (i.toggleActive = function (t) {
            ...
            (i.sign = function (t) {
              if (i.active && i.hugoLoaded) {
                ...
                n
                  ? i.signAnimationsCodes(JSON.parse(n), t)
                  : i.signOrWaitRequest(t);
              }
            }),
            (i.signOrWaitRequest = function (t) {
              if (0 !== i.requestList.length) {
                var e =
                  i.requestList[t.text + "-" + t.startTime + "-" + t.endTime];
                if (e)
                  switch (e.status) {
                    case "downloading":
                      i.player().pause(),
                        i.player().loadingDisplay.toggleActive(!0),
                        (e.onStatusChange = function () {
                          i.signAnimationsCodes(e.preparedSequences, t),
                            i.player().play(),
                            i.player().loadingDisplay.toggleActive(!1);
                        });
                      break;
                    default:
                      i.signAnimationsCodes(e.preparedSequences, t);
            ...
            (i.signAnimationsCodes = function (t, e) {
              i.player().trigger("cuesignalizing", e),
                i.hugo
                  .signAnimationsCodes(t)
                  .then(function () {
            ...
            (i.prepare = function (t) {
              ...
              if (
                !(
                  ...
                  (i.requestList[e] && "fail" !== i.requestList[e].status)
                )
              ) {
                var n = {};
            ...
            (i.downloadSign = function (t) {
              return new Promise(function (e, n) {
                ...
                i.player().trigger("cuedownloading", t),
                  i.hugo
                    .translate(t.text, {
            ...
            (i.hugo = n.hugo),
            i.hugo.on("notCompatible", i.onHugoError),
            i.hugo.on("addedToSignQueue", i.onAddedToSignQueue),
            t.on("play", i.onPlayerResume),
            i.addChild("HugoSideButton"),
            i
          );
        }
        return (
    ...
    (c.maxTimeScale = 1.7),
      (c.minTimeScale = 1),
      (c.signDuration = 0.2),
      window.videojs.registerComponent("HugoDisplay", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
    ...
    var a = (function () {
      ...
      c = (function (t) {
        function e(t, n) {
          ...
          return (
            (i._side = null),
            (i.toggleSide = function (t) {
              (i._side = t || ("right" === i._side ? "left" : "right")),
                i.player().signLanguageTrackDisplay.toggleSide(i._side);
            }),
            i.toggleSide("right"),
            i
          );
    ...
    window.videojs.registerComponent("HugoSideButton", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
          ...
          a(e, [
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  (this.messageElem = this.elem.querySelector(".ht-es-text")),
                  (this.elem.className = "vjs-ht-error-splash"),
                  this.elem
                );
              },
            },
    ...
    window.videojs.registerComponent("ErrorSplash", c),
      (e.default = c),
      (t.exports = e.default);
  },
  function (t, e, n) {
            ...
            if (
              ...
              try {
                ...
                (void 0 !== t.number && -2146823252 !== t.number) ||
                  ((l.enumerable = !1), n.defineProperty(e, "classList", l));
              }
            } else
  ...
  function (t, e, n) {
    ...
    var o = (function () {
      ...
      i = (function () {
        function t() {
          var e = this;
          r(this, t),
            (this.getValidTextTrack = function (t) {
              ...
              value: function (t) {
                for (
                  ...
                  if (e[a].indexOf("--\x3e") >= 0) {
                    var s = e[a].split(/[ \t]+-->[ \t]+/);
                    if (2 !== s.length)
                      throw new Error('Error when splitting "--\x3e": ' + e[a]);
                    (r = this.parseTimestamp(s[0])),
                      (o = this.parseTimestamp(s[1]));
                  } else if ("" === e[a]) {
                    if (r && o) {
    ...
    (i.acceptedLanguages = ["pt", "br", "pt-br", "pt_br", "ptbr"]),
      (e.default = i),
      (t.exports = e.default);
  },
  function (t, e, n) {
  ...
  function (t, e) {
    t.exports =
      "\"data:image/svg+xml,%3Csvg fill='%23FFF' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z' fill='none' stroke='%23b6b6b6' opacity='.54'/%3E%3C/svg%3E\"";
  },
  function (t, e) {
    t.exports =
      "\"data:image/svg+xml,%3Csvg width='145' height='100' viewBox='0 0 145 100' xmlns='http://www.w3.org/2000/svg'%3E %3Ctitle%3Eright-side%3C/title%3E %3Cpath d='M115.429 84.444V16.643H28.643v67.801h86.786zm9.793-.376c0 2.56-.98 4.82-2.938 6.78-1.959 1.958-4.219 2.938-6.78 2.938H28.718c-2.561 0-4.821-.98-6.78-2.938-1.959-1.96-2.938-4.22-2.938-6.78V16.492c0-2.561.98-4.784 2.938-6.667C23.897 7.942 26.157 7 28.718 7h86.786c2.561 0 4.821.942 6.78 2.825 1.959 1.883 2.938 4.106 2.938 6.667v67.576zm-11.476-14.465H84.818v-38.42h28.928v38.42z' fill='%23757575' fill-rule='evenodd' /%3E %3C/svg%3E\"";
  },
  function (t, e) {
    t.exports =
      "\"data:image/svg+xml,%3Csvg width='145' height='100' viewBox='0 0 145 100' xmlns='http://www.w3.org/2000/svg'%3E %3Ctitle%3Eleft-side%3C/title%3E %3Cpath d='M28.794 84.444V16.643h86.785v67.801H28.794zM19 84.068c0 2.56.98 4.82 2.938 6.78 1.959 1.958 4.219 2.938 6.78 2.938h86.786c2.561 0 4.821-.98 6.78-2.938 1.959-1.96 2.938-4.22 2.938-6.78V16.492c0-2.561-.98-4.784-2.938-6.667C120.325 7.942 118.065 7 115.504 7H28.718c-2.561 0-4.821.942-6.78 2.825C19.98 11.708 19 13.931 19 16.492v67.576zm11.476-14.465h28.929v-38.42H30.476v38.42z' fill='%23757575' fill-rule='evenodd' /%3E %3C/svg%3E\"";
  },
]);
