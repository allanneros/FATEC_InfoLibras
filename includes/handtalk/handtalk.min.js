!(function (t) {
    ...
    function (t, e, n) {
      ...
      function A(t) {
        ...
        return (t.attrs.type = "text/css"), l(e, t.attrs), r(t, e), e;
      }
      function s(t) {
    ...
    function (t, e, n) {
      ...
      function i(t, e) {
        if (1 === arguments.length) {
          for (var n = t[0], o = 1; o < t.length; o++) n = i(n, t[o]);
          return n;
        }
        for (var r in e)
          if ("class" === r) {
      ...
      function o(t, e) {
        for (
          var n, i = "", o = "", r = Array.isArray(e), A = 0;
          A < t.length;
          A++
        )
          (n = a(t[A])) && (r && e[A] && (n = c(n)), (i = i + o + n), (o = " "));
        return i;
      }
      function r(t) {
        var e = "",
      ...
      function A(t) {
        ...
        if ("object" == typeof t) {
          var e = "";
          for (var n in t) u.call(t, n) && (e = e + n + ":" + t[n] + ";");
          return e;
        }
      ...
      function c(t) {
        ...
        var i,
          ...
          r,
          a = "";
        for (i = n.index, o = 0; i < e.length; i++) {
          ...
          o !== i && (a += e.substring(o, i)), (o = i + 1), (a += r);
        }
      ...
      (e.merge = i), (e.classes = a), (e.style = A), (e.attr = s), (e.attrs = l);
      var d = /["&<>]/;
      (e.escape = c), (e.rethrow = h);
    },
    function (t, e, n) {
      "use strict";
          ...
          function () {
            ...
            return /trident/i.test(n[1])
              ...
              : ((n = n[2]
                ...
                e && n.splice(1, 1, e[1]),
                { name: n[0], version: n.splice(1, n.length).join("") });
          }),
        s = function () {
        ...
        (e.swipeDetect = function (t, e) {
          var n =
              arguments.length > 2 && void 0 !== arguments[2]
                ...
                : 100,
            i =
              arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 50,
            o =
              ...
              for (
                ...
                try {
                  ...
                  if (
                    ((f = n.read
                      ? n.read(f, g)
                      : n(f, g) || f.replace(h, decodeURIComponent)),
                    this.json)
                  )
                    try {
                      f = JSON.parse(f);
  ...
  */
      ...
      (function (i, o) {
        ...
        !(function (i, o) {
          "object" === A(e) && void 0 !== t
            ? (t.exports = o())
            : ((r = o),
              void 0 !== (a = "function" == typeof r ? r.call(e, n, e, t) : r) &&
                (t.exports = a));
        })(0, function () {
          function t(t) {
          ...
          function E(t, e) {
            t._state === tt && ((t._state = nt), (t._result = e), W(x, t));
          }
          function k(t, e, n, i) {
          ...
          function P(t, n, i, o) {
            ...
            if (r) {
              if (
                ((a = L(i, o)),
                a === ot ? ((l = !0), (A = a.error), (a.error = null)) : (s = !0),
                n === a)
              )
                return void E(n, g());
            } else (a = o), (s = !0);
                ...
                (t.prototype._eachEntry = function (t, e) {
                  ...
                  if (i === u) {
                    ...
                    if (o === h && t._state !== tt)
                      ...
                      var r = new n(d);
                      y(r, t, o), this._willSettleAt(r, e);
                    } else
                      this._willSettleAt(
                        new n(function (e) {
                          return e(t);
    ...
    function (t, e, n) {
          ...
          function e(t) {
            ...
            (i.logger = null),
              ...
              (i.addListenersToIframe = function (t) {
                if (i.textManager)
                  try {
                    ...
                    i.logger.warn(
                      "Falha ao adicionar EventListener no iframe " + t
                    );
                  }
              }),
              ...
              (i._auth = function () {
                return (
                  i._authPromise ||
                    (i._authPromise = new b.default(function (t, n) {
                      i.emit("authenticating");
                      var o = new XMLHttpRequest();
                      i.uid = m.default.get("ht-plugin-uid");
                      var r = { token: i._token };
                      i.config.videoEnabled && (r.videoEnabled = !0),
                        o.open(
                          "GET",
                          "https://translation.handtalk.me/web/auth?" +
                            w.default.stringify(r)
                        ),
                        o.setRequestHeader("Version", "3"),
                        i.uid 
                        && o.setRequestHeader("UID", i.uid)
                      ...
                      var a = function () {
                        ...
                        var a = r,
                          ...
                          c = a.message;
                        if (
                          (i.logger.debug("auth uid", A),
                          i.logger.debug("auth custom", s),
                          i.logger.debug("auth error", l),
                          i.logger.debug("auth message", c),
                          406 === o.status &&
                            i.logger.warn(
                              (l || "A sua assinatura está desabilitada") +
                                ". Acesse https://account.handtalk.me para regularizar o serviço ou entre em contato via suporte@handtalk.com.br"
                            ),
                          200 !== o.status)
                        )
                          return (
                        ...
                        !i.uid &&
                          A &&
                          m.default.set("ht-plugin-uid", A, { expires: 3650 }),
                          (i.uid = m.default.get("ht-plugin-uid")),
                            ...
                            Object.keys(n).forEach(function (t) {
                              var i = n[t],
                                r =
                                  ...
                                  0 === i.indexOf("https://")
                                    ? i
                                    : "https://api.handtalk.me/unity/textures/" +
                                      i;
                              e.customCorrespondingObject[t].forEach(function (
                                t
                              ) {
                                o[t] = {
                                  visible: !("hide" === i),
              ...
              (i.startHugo = function () {
                return (
                  i._hugoPromise ||
                    (i._hugoPromise = new b.default(function (t, e) {
                      var n = h.default.createElement("script");
                      (n.src =
                        "https://plugin.handtalk.me/core/2.0.21/hugo.min.js"),
                        (n.onload = function () {
                          (i._hugo = new Hugo(i._token)),
                            i._hugo.on(
                              "downloadDependenciesProgress",
                              i.emit.bind(i, "hugoDownloadDependenciesProgress")
                            ),
                            i._hugo.on(
                              "downloadSceneDataProgress",
                              i.emit.bind(i, "hugoDownloadSceneDataProgress")
                            ),
                            i._hugo.on(
                              "translating",
                              i.emit.bind(i, "translating")
                            ),
                            i._hugo.on(
                              "errorOnTranslate",
                              i.emit.bind(i, "errorOnTranslate")
                            ),
                            i._hugo.on(
                              "translated",
                              i.emit.bind(i, "translated")
                            ),
                            i._hugo.on(
                              "notCompatible",
                              i.emit.bind(i, "notCompatible")
                            ),
                            t(i._hugo);
                        }),
                        (n.onerror = e),
              ...
              (i.toggleSide = function () {
                "right" === i.side
                  ? (i.side = "left")
                  : "left" === i.side && (i.side = "right");
              }),
              (i.destroy = function () {
                (i.open = !1),
                  i.textManager && i.textManager.destroy(),
                  i.pageTranslatorManager &&
                    i.pageTranslatorManager.activated &&
                    (i.pageTranslatorManager.activated = !1),
                  i.pageSpeechManager &&
                    i.pageSpeechManager.activated &&
                    (i.pageSpeechManager.activated = !1),
            ...
            if (
              ((i.config = (0, g.default)(e.defaultConfig, t)),
              e.deviceInfo.isMobile && (i.config = (0, g.default)(i.config, a)),
              (i.logger = i.config.debug
                ? (0, C.createLogger)(3)
                : (0, C.createLogger)(1)),
              ...
              return (
                (n = i.logger.error(
                  "O plugin da Hand Talk já foi inicializado nesta página"
                )),
                r(i, n)
              );
            (i._token = i.config.token),
              ...
              !i.config.doNotTrack &&
                i.config.experimentalAnalyticsEnabled &&
                i.analyitcsManager.init(),
            ...
            var s = i.config.pageSpeech && !e.deviceInfo.isMobile,
              c =
                (i.config.textEnabled && !e.deviceInfo.isMobile) ||
                (i.config.mobileEnabled && e.deviceInfo.isMobile);
            return (
              (c || s) &&
                ((i.drawer = e.deviceInfo.isMobile
                  ? new S.default(i)
                  : new Z.default(i)),
              ...
              i.logger.info(
                "Plugin da Hand Talk iniciado com as seguintes configurações",
                i.config
              ),
              (0, D.videojsReplace)(i),
              (0, D.ytEmbedReplace)(i),
              (0, D.vimeoReplace)(i),
              i.config.ytEmbedReplace &&
                i.once("videoManagerReady", i.replaceYtEmbedAll),
              i.config.videojsReplace &&
                i.once("videoManagerReady", i.replaceVideoJsAll),
              i.config.vimeoReplace &&
                i.once("videoManagerReady", i.replaceVimeoAll),
              i
            );
          }
          return (
                ...
                get: function () {
                  return (
                    this._getHugoPromise ||
                      (this._getHugoPromise = b.default
                        .resolve()
                        .then(this._auth)
                        .then(this._loadHugo)),
                    this._getHugoPromise
      ...
      (Q.version = x.version),
        ...
        (Q.deviceInfo = (0, C.getDeviceInfo)()),
    ...
    function (t, e, n) {
      ...
      function A() {
        p &&
          f &&
          ((p = !1), f.length ? (g = f.concat(g)) : (m = -1), g.length && s());
      }
      function s() {
        if (!p) {
          var t = r(A);
      ...
      (d.nextTick = function (t) {
        ...
        g.push(new l(t, e)), 1 !== g.length || p || r(s);
      }),
          ...
          (function (t) {
            if ("Element" in t) {
              ...
              if (
                ...
                var c = { get: l, enumerable: !0, configurable: !0 };
                try {
                  n.defineProperty(e, "classList", c);
                } catch (t) {
                  (void 0 !== t.number && -2146823252 !== t.number) ||
                    ((c.enumerable = !1), n.defineProperty(e, "classList", c));
                }
              } else
    ...
    function (t, e) {
      t.exports = {
        ...
        scripts: {
          ...
          "release-stage":
            "cd ../ && node tools/pluginRelease.js plugin-web stage",
          "release-prod":
            "cd ../ && node tools/pluginRelease.js plugin-web production",
        ...
        author: "Hand Talk",
        license: "UNLICENSED",
        bugs: { url: "https://github.com/Hand-Talk/sitesplugin/issues" },
    ...
    function (t, e, n) {
      ...
      var i = "table-row,block,list-item",
        ...
        s = function (t, e) {
          ...
          return "SCRIPT" === t.tagName
            ? "none"
            : n[e]
            ? "block" === n[e] && "TD" === t.tagName
              ? "feaux-inline"
              : n[e]
            : "LI,P,TR".indexOf(t.tagName) > -1
            ? "block"
            : t.style[e];
        },
        l = function (t) {
      ...
      e.default = function (t) {
        var e = "";
        (t = t.cloneNode(!0)), (t.innerHTML = t.innerHTML.replace(/<br>/g, "\n"));
          ...
          o(
            (function t(n) {
              if (/pre/.test(s(n, "whiteSpace")))
                return (
                  (e += n.innerHTML.replace(/\t/g, " ").replace(/\n/g, " ")), ""
                );
              if ("none" === s(n, "display")) return "";
              var i = l(n) ? "\n" : " ";
              return (
                (e += i),
            ...
            return (
              ...
              (n.getText = function (t) {
                var e = t.tagName,
                  ...
                  o = (e || "").toLowerCase();
                if (!n.activated)
                  return n.ht.logger.debug("TextManager desativado"), !1;
                if (!(0, d.checkException)(i, t))
                  return n.ht.logger.debug("Elemento é uma exceção"), !1;
                if (o && HT.skipTags.indexOf(o) >= 0)
                  return n.ht.logger.debug("Tag do elemento é", o), !1;
                if ("img" === o) {
                  var r = t.getAttribute("data-ht-alt") || t.getAttribute("alt");
                  return !!n.checkTextSize(r) && r;
                }
                if (!n.checkTextSize(t.innerText)) return !1;
                if ((0, d.isChildren)(t, ".ht-skip"))
                  return (
                    n.ht.logger.debug(
                      "Elemento tem ou é filho de um .ht-skip",
                      o
                    ),
                    !1
                  );
                var a = (0, d.getPlainText)(t);
                return !!n.checkTextSize(a) && a;
              }),
              (n.checkTextSize = function (t) {
                return (
                  (t.length > 0 && t.length < n.ht.config.maxTextSize) ||
                  (n.ht.logger.debug(
                    "O Elemento possui muitos ou nenhum caractere dentro do texto",
                    t.length
                  ),
                  !1)
                );
              ...
              (n.onTouchEnd = function (t) {
                if (!n.activated) return !1;
                n.hasMoved || n.onClick(t), (n.hasMoved = !1);
              }),
              (n.addEventListeners = function (t) {
                HT.deviceInfo.isMobile
                  ? (t.addEventListener("touchmove", n.onTouchMove, !0),
                    t.addEventListener("touchend", n.onTouchEnd, !0))
                  : (t.addEventListener("mouseover", n.onMouseOver),
              ...
              (n.addExtraStyle = function (t) {
                var e =
                    t.contentDocument.head ||
                    t.contentDocument.querySelector("head"),
              ...
              (n.addIframeListeners = function (t) {
                t.getAttribute("data-ht-bindedevents")
                  ? n.ht.logger.info(
                      "Ignorando iframe que ja possui os Event Listeners",
                      t
                    )
                  : (n.addEventListeners(t.contentDocument),
                    n.addExtraStyle(t),
                    t.setAttribute("data-ht-bindedevents", !0));
              }),
              (n.addIframesListenersAll = function () {
                Array.prototype.forEach.bind(
                  l.default.body.querySelectorAll("iframe")
                )(function (t) {
                  try {
              ...
              (n.removeEventListener = function (t) {
                HT.deviceInfo.isMobile
                  ? (t.removeEventListener("touchmove", n.onTouchMove, !0),
                    t.removeEventListener("touchend", n.onTouchEnd, !0))
                  : (t.removeEventListener("mouseover", n.onMouseOver),
                ...
                n.removeEventListener(l.default),
                  Array.prototype.forEach.bind(
                    ...
                    try {
                      ...
                      n.ht.logger.warn(
                        "Falha ao remover EventListener no iframe " + t
                      );
                    }
                  }),
                  (n.activated = !1),
            ...
            A(e, [
              {
                ...
                set: function (t) {
                  (this._activated = t),
                    t &&
                      (this.addedListeners ||
                        (this.addEventListeners(l.default),
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        e.push([
          t.i,
          '.ht-signlanguage-hover{cursor:url("https://api.handtalk.me/assets/imgs/cursor-signlanguage.cur"),url(' +
            n(13) +
            "),url(" +
            n(14) +
            '),auto!important;text-decoration:underline!important}.ht-speech-hover{cursor:url("https://api.handtalk.me/assets/imgs/cursor-speech.cur"),url(' +
            n(15) +
            "),url(" +
            n(16) +
            "),auto!important;text-decoration:underline!important}.ht-mobile-hover{background-color:rgba(241,196,15,.3)}",
          "",
        ]);
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      var a = n(0),
        ...
        f = function t(e, n) {
          r(this, t), g.call(this), (this.videoManager = e);
          var i = n.dataset.ht,
            o = {},
            a = {};
          if (i) {
            var A = d(i);
            (o = this.getSource(A)), (a = this.getSubtitle(A));
          } else
        ...
        g = function () {
          ...
          (this.videoManager = null),
            ...
            (this.createGenericPlayer = function (e, n, i) {
              ...
              t.downloadSubtitle(i)
                .then(function (i) {
                  t.videoManager.htVideo.createAccessibilePlayer(
                    e,
                    n.src,
                    n.type,
                    i
            ...
            (this.createYtPlayer = function (e, n, i) {
              if (
                ((i && i.type) ||
                  (i = {
                    type: "yt",
                    src: (0, c.isValidUrl)(n.src) ? (0, c.getYtId)(n.src) : n.src,
                  }),
            ...
            (this.createVimeoPlayer = function (e, n, i) {
              if (
                ((i && i.type) ||
                  (i = {
                    type: "vimeo",
                    src: (0, c.isValidUrl)(n.src)
                      ? (0, c.getVimeoId)(n.src)
                      : n.src,
                  }),
            ...
            (this.createPlayerWithoutSubtitle = function (e, n, i) {
              t.videoManager.htVideo.createAccessibilePlayer(
                ...
                t.videoManager.ht.logger.warn(
                  "Tradutor de vídeos | Formato de legenda não suportado",
                  n,
                  i
                );
            }),
            (this.getSource = function (t) {
              if (t.src) {
                var e = t.src.split(":"),
                  n = o(e);
                return { type: n[0], src: n.slice(1).join(":") };
              }
            }),
            ...
            (this.downloadSubtitle = function (t) {
              var e =
                "yt" === t.type || "vimeo" === t.type
                  ? "https://translation.handtalk.me/web/subtitle?type=" +
                    t.type +
                    "&src=" +
                    t.src
                  : t.src;
        ...
        p = function t(e) {
          ...
          r(this, t),
            ...
            (this.loadDependencies = function () {
              return (
                n._loadDependenciesPromise ||
                  (n._loadDependenciesPromise = new l.default(function (e, i) {
                    window.videojs
                      ? (window.videojs.VERSION &&
                          window.videojs.VERSION.split(".")[0] <
                            t.vjsMinVersion &&
                          n.ht.logger.warn(
                            "A versão " +
                              window.videojs.VERSION +
                              " do videojs pode apresentar instabilidade com o Tradutor de Vídeos. Considere atualizar para versão " +
                              t.vjsMinVersion +
                              ".0.0 ou superior"
                          ),
                        n
            ...
            (this.loadVideoPlayerScript = function () {
              return (
                n._loadVideoPlayerPromise ||
                  (n._loadVideoPlayerPromise = new l.default(function (t, e) {
                    var i = A.default.createElement("script");
                    (i.src =
                      "https://plugin.handtalk.me/video/3.5.1/ht-video-player.min.js"),
                      (i.onload = function () {
                        n.ht.logger.debug("ht video carregado"), t();
                      }),
                      (i.onerror = e),
            ...
            (this.loadVideojsScript = function () {
              return (
                n._loadVideojsScriptPromise ||
                  (n._loadVideojsScriptPromise = new l.default(function (t, e) {
                    var i = A.default.createElement("script");
                    (i.src =
                      "https://plugin.handtalk.me/libs/videojs/7.2.4/video.min.js"),
                      (i.onload = function () {
                        n.ht.logger.debug(
                          "Versão " + videojs.VERSION + " do videojs injetada"
                        ),
                          t();
                      }),
                      (i.onerror = e),
            ...
            (this.loadVideojsStyle = function () {
              return (
                n._loadVideojsStylePromise ||
                  (n._loadVideojsStylePromise = new l.default(function (t, e) {
                    var i = A.default.createElement("link");
                    (i.type = "text/css"),
                      (i.rel = "stylesheet"),
                      i.setAttribute("rel", "stylesheet"),
                      (i.onload = function () {
                        n.ht.logger.debug("CSS do videojs injetado"), t();
                      }),
                      (i.onerror = e),
                      (i.href =
                        "https://plugin.handtalk.me/libs/videojs/7.2.4/video-js.min.css"),
                      A.default.head.appendChild(i);
                  })),
                n._loadVideojsStylePromise
              );
            ...
            (this.disableCurrentAcessibleVideo = function () {
              n.currentVideo &&
                (n.currentVideo.signLanguageButton.toggleActive(!1),
                n.currentVideo.pause());
            }),
            (this.search = function () {
              var t = Array.prototype.map.bind(
                A.default.querySelectorAll("video[data-ht]")
              )(function (t) {
                return t;
              });
              t.length > 0 &&
                n.ht.logger.warn(
                  "O construtor de vídeos através de um único atributo está depreciado, e pode ser removido em futuras versões. Para mais detalhes visite https://docs.handtalk.me/#utilizando-o-player-acessivel-tradutor-de-videos"
                ),
                t.forEach(function (t) {
                  n.getItem(t);
                }),
                Array.prototype.map
                  .bind(A.default.querySelectorAll("video[data-ht-src-type]"))(
                    function (t) {
                      return t;
                    }
                  )
            ...
            (this.getItem = function (t) {
              ...
              return e
                ? e.item
                : (n.elemItems.push({ elem: t, item: new f(n, t) }),
                  n.getItem(t));
            }),
            (this.ht = e),
            ...
            this.ht.once("errorOnAuth", function () {
              (n.hasProblem = !0),
                (n.htVideo.error = !0),
                n.ht.pageTranslatorManager &&
                  (n.ht.pageTranslatorManager.activated = !0);
            }),
            this.loadDependencies()
              .then(function () {
                n.ht.startHugo().then(function (t) {
                  (n.htVideo = new HTVideo({ hugo: t, authEnabled: !1 })),
              ...
              .catch(function () {
                n.ht.logger.error(
                  "Falha ao baixar dependencias do tradutor de vídeos"
                );
              });
        };
      (p.vjsMinVersion = 5), (e.default = p);
    },
    function (t, e, n) {
      "use strict";
      function i(t, e) {
          ...
          function t(e) {
            ...
            if (
              ...
              (this.onValidElementClicked = function (t, e) {
                n.activated &&
                  (n.ht.logger.info("Texto a ser convertido para audio", e),
                  n.speak(e));
              }),
              (this.onValidElementOver = function (t) {
                n.activated &&
                  !HT.deviceInfo.isMobile &&
                  t.classList.add("ht-speech-hover");
              }),
              (this.onValidElementOut = function (t) {
                n.activated &&
                  t.classList &&
                  t.classList.remove("ht-speech-hover");
              }),
              (this.speak = function (t) {
                if (n.activated) {
                  var e = n.prepareUtterance(t);
                  n.stop(), n.synth.speak(e);
                }
              }),
              (this.stop = function () {
                n.synth.cancel();
              ...
              void 0 === window.speechSynthesis ||
                void 0 === window.SpeechSynthesisUtterance)
            )
              return this.onError();
            (this.synth = window.speechSynthesis),
              (this.firstActivation =
                "false" !== a.default.get("ht-first-activation-speech")),
              this.stop(),
              this.prepareUtterance(),
              this.ht.textManager.on(
                "validElementClicked",
                this.onValidElementClicked
              ),
            ...
            o(t, [
              {
                ...
                set: function (e) {
                  if (e) {
                    (this.ht.textManager.activated = !0), (this._activated = e);
                    var n = this.firstActivation
                      ? t.welcomeMessage
                      : t.activeMessage;
                    this.speak(n),
                      this.ht.drawer.showSpeechTextDialog(
                        n,
                        this.firstActivation ? 4500 : 3e3
                      ),
                      this.firstActivation &&
                        (a.default.set("ht-first-activation-speech", !1, {
                          expires: 7,
                        }),
      ...
      (A.defaultLang = "pt-BR"),
        ...
        (A.welcomeMessage =
          "Leitor de sites ativado, clique sobre um texto para ouvi-lo."),
        (A.errorMessage =
          "Seu navegador não suporta a conversão de texto para voz."),
        (e.default = A);
    },
    function (t, e, n) {
      "use strict";
        ...
        l = (function () {
          function t(e) {
            ...
            i(this, t),
              ...
              (this.onValidElementClicked = function (t, e) {
                var i = t.target;
                if (t.view === window && (0, s.isChildren)(i, "a")) {
                  var o = (0, s.getMainLinkElement)(i);
                  o && n.ht.drawer.showPromptLinkAt(o, t);
                } else n.ht.drawer.hidePromptLink();
                if (HT.deviceInfo.isMobile) {
                  if (n._hugoTranslating) return !1;
                  n._currentHoverElem &&
                    n._currentHoverElem.classList.remove("ht-mobile-hover"),
              ...
              (this.onValidElementOver = function (t) {
                HT.deviceInfo.isMobile ||
                  t.classList.add("ht-signlanguage-hover");
              }),
              (this.onValidElementOut = function (t) {
                      ...
                      e
                        ...
                        .finally(function () {
                          n.ht.emit("signalized"),
                            HT.deviceInfo.isMobile &&
                              i.classList.remove("ht-mobile-hover");
                        });
                  });
                });
              }),
                      ...
                      ? (this.ht.hugoLoaded
                        ...
                        this.ht.hugo.then(function (t) {
                          (t._mainMixer.timeScale = 1),
                            e.firstOpen &&
                              (e.ht.drawer.signWithHelperText(A.INFO_TEXT),
                              a.default.set("ht-first-open", !1, { expires: 7 }),
                              (e.firstOpen = !1));
                        }))
                      : (this._currentHoverElem &&
                          this._currentHoverElem.classList.remove(
                            "ht-mobile-hover"
                          ),
                        this.ht.hugo.then(function (t) {
                          t.stop();
                        ...
                        (this.ht.textManager.activated = !1)),
                    a.default.set("ht-auto-open", t, { expires: 1 / 48 }),
                    t &&
                      this.ht.videoManager &&
                      this.ht.videoManager.disableCurrentAcessibleVideo();
                },
              },
            ]),
            t
    ...
    function (t, e, n) {
      ...
      var r = n(0),
        ...
        g = n(70),
        p = (e.INFO_TEXT =
          "Olá, eu sou o Hugo, sou intérprete de Libras da Hand Talk e estou aqui para lhe ajudar! Clique em textos do site que eu faço a tradução para Libras!"),
        m = function t(e) {
          var n = this;
          o(this, t),
            (this.ht = null),
            ...
            (this.signWithHelperText = function (t) {
              return n.ht.hugo.then(function (e) {
                var i = function () {
                  n.ht.textManager &&
                    n.ht.drawer &&
                    n.ht.drawer.textDialog &&
                    n.ht.drawer.textDialog.show(t);
                };
                n.ht.once("translated", i), n.ht.once("errorOnTranslate", i);
                var o = function () {
                  n.ht.emit("signalized", !0),
                    n.ht.textManager &&
                      n.ht.drawer &&
                      n.ht.drawer.textDialog &&
                      n.ht.drawer.textDialog.hide();
                };
                e.sign(t, {
                  translationURL: "https://translation.handtalk.me/web/",
                  doNotTrack: n.ht.config.doNotTrack || !1,
            ...
            (this.elem.innerHTML = (0, f.default)()),
            ...
            (this.rate.onclick = function () {
              ...
              (n.ratingDialog = new u.default(n.ht, t, function (t) {
                n.signWithHelperText("Obrigado!"), t();
              })),
                n.ht.textManager &&
                  n.ht.drawer &&
                  n.ht.drawer.elem.appendChild(n.ratingDialog.elem);
            }),
            ...
            this.ht.on("activated", function (t) {
              "textManager" === t &&
                n.ht.pageTranslatorManager.activated &&
                n.ht.hugo.then(function () {
                  (n.side.visible = !0),
                    (n.repeat.visible = !0),
                    (n.rate.visible = !0),
                    (n.info.visible = !0),
            ...
            o(t, [
              {
                ...
                set: function (t) {
                  (this._visible = t),
                    (this.elem.style.display = this.visible
                      ? "inline-block"
                      : "none");
                },
              },
              {
                ...
                set: function (t) {
                  (this._activated = t),
                    this.activated
                      ? this.elem.classList.add("ht-ac-activated")
                      : this.elem.classList.remove("ht-ac-activated");
                },
              },
            ]),
            t
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        e.push([
          t.i,
          "._27ATUArepghQ7A4KbsDe9e{display:inline-block;width:24px;height:24px;margin-left:4px;cursor:pointer;background-size:contain;background-repeat:no-repeat;background-position:50%}._27ATUArepghQ7A4KbsDe9e.ht-ac-repeat{background-image:url(" +
            n(51) +
            ")}._27ATUArepghQ7A4KbsDe9e.ht-ac-rate{background-image:url(" +
            n(52) +
            ")}._27ATUArepghQ7A4KbsDe9e.ht-ac-info{background-image:url(" +
            n(53) +
            ")}._27ATUArepghQ7A4KbsDe9e.ht-ac-activated{-webkit-filter:brightness(.7);filter:brightness(.7)}.ht-right ._27ATUArepghQ7A4KbsDe9e.ht-ac-side{background-image:url(" +
            n(54) +
            ")}.ht-left ._27ATUArepghQ7A4KbsDe9e.ht-ac-side{background-image:url(" +
            n(55) +
            ")}",
          "",
        ]),
        (e.locals = { action: "_27ATUArepghQ7A4KbsDe9e" });
    },
    function (t, e) {
      t.exports =
        "\"data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ctitle%3Erepeat%3C/title%3E%3Cpath d='M50.265 26.764c8.655 0 16.03 3.055 22.124 9.165 6.095 6.11 9.142 13.442 9.142 21.996 0 8.676-3.078 16.069-9.233 22.179-6.156 6.11-13.5 9.165-22.033 9.165-8.532 0-15.876-3.055-22.032-9.165C22.078 73.994 19 66.6 19 57.924h7.862c0 6.477 2.286 12.007 6.857 16.59 4.57 4.582 10.086 6.873 16.546 6.873 6.46 0 11.976-2.291 16.547-6.874 4.571-4.582 6.857-10.112 6.857-16.588 0-6.477-2.286-12.006-6.857-16.589-4.57-4.582-10.086-6.874-16.547-6.874v15.764L30.702 30.613 50.265 11v15.764z' fill='%23DDD' fill-rule='evenodd'/%3E%3C/svg%3E\"";
    },
    function (t, e) {
      t.exports =
        "\"data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%23FFF' height='24' width='24'%3E%3Crect width='100%25' height='100%25' fill='none'/%3E%3Cg class='currentLayer'%3E%3Ctitle%3ELayer 1%3C/title%3E%3Cpath d='M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z' fill='%23dadada'/%3E%3C/g%3E%3C/svg%3E\"";
    },
    function (t, e) {
      t.exports =
        "\"data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' fill='%23FFF' height='24' width='24'%3E%3Crect width='100%25' height='100%25' fill='none'/%3E%3Cg class='currentLayer'%3E%3Ctitle%3ELayer 1%3C/title%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z' class='selected' fill='%23dadada'/%3E%3C/g%3E%3C/svg%3E\"";
    },
    function (t, e) {
      t.exports =
        "\"data:image/svg+xml,%3Csvg width='145' height='100' viewBox='0 0 145 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ctitle%3Eleft-side%3C/title%3E%3Cpath d='M28.794 84.444V16.643h86.785v67.801H28.794zM19 84.068c0 2.56.98 4.82 2.938 6.78 1.959 1.958 4.219 2.938 6.78 2.938h86.786c2.561 0 4.821-.98 6.78-2.938 1.959-1.96 2.938-4.22 2.938-6.78V16.492c0-2.561-.98-4.784-2.938-6.667C120.325 7.942 118.065 7 115.504 7H28.718c-2.561 0-4.821.942-6.78 2.825C19.98 11.708 19 13.931 19 16.492v67.576zm11.476-14.465h28.929v-38.42H30.476v38.42z' fill='%23DDD' fill-rule='evenodd'/%3E%3C/svg%3E\"";
    },
    function (t, e) {
      t.exports =
          ...
          o(this, t),
            ...
            (this.destroy = function () {
              try {
                ...
                (i.elem.style.display = "none"), i.ht.logger.warn(t);
              }
            }),
            (this.ht = e),
            (this.elem = a.default.createElement("div")),
            this.elem.classList.add(A.ratingDialog),
            (this.elem.innerHTML = (0, l.default)({ text: n })),
            (this.ratingElem = this.elem.querySelector(
              ".ht-rd-box-content-rating"
            )),
            ...
            (this.confirmElem = this.elem.querySelector(
              ".ht-rd-box-footer-confirm"
            )),
            (this.confirmElem.onclick = function () {
              var t = i.value;
              i.ht.logger.debug(
                "A frase " + n + " será salva com a avaliação " + t
              );
              var e = new XMLHttpRequest();
              e.open(
                "POST",
                "https://translation.handtalk.me/ratePhrase?phrase=" +
                  encodeURI(n) +
                  "&rating=" +
                  t
              ),
    ...
    function (t, e) {
      t.exports =
        "\"data:image/svg+xml,%3Csvg fill='%23FFF' height='24' viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h24v24H0z' fill='none'/%3E%3Cpath d='M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z'/%3E%3C/svg%3E\"";
    },
    function (t, e, n) {
      function i(t) {
        var e,
        ...
        return (
          function (t) {
            n =
              n +
              '<div class="ht-rd-blocker"></div><div class="ht-rd-box"><div class="ht-rd-box-close"></div><div class="ht-rd-box-title">Avalie a tradução</div><div class="ht-rd-box-content"><div class="ht-rd-box-content-text">' +
              o.escape(null == (e = t) ? "" : e) +
              '</div><div class="ht-rd-box-content-rating"><label class="ht-very-bad" data-value="1"></label><label class="ht-bad" data-value="2"></label><label class="ht-neutral" data-value="3"></label><label class="ht-good" data-value="4"></label><label class="ht-very-good" data-value="5"></label></div></div><div class="ht-rd-box-footer"><input class="ht-rd-box-footer-confirm" type="button" disabled></div></div>';
          }.call(
            this,
            "text" in i ? i.text : "undefined" != typeof text ? text : void 0
          ),
          n
        );
      }
    ...
    function (t, e, n) {
      function i(t) {
        var e = "";
        return (e +=
          '<a class="ht-ac-copy" href="https://www.handtalk.me/" target="_blank">&copy; Hand Talk</a><div class="ht-ac-spacer"></div>');
      }
      n(3);
      t.exports = i;
    },
        ...
        i(this, t),
            ...
            n
              ...
              .then(function () {
                (n.htAnalytics = new HTAnalytics()),
                  n.htAnalytics
                    .init(n.ht.config.parentElement)
                    .then(function () {
                      (n.isReady = !0),
                    ...
                    .catch(function (t) {
                      n.ht.logger.warn(
                        "Falha ao injetar o script ht-analytics",
                        t
                      );
                    });
              })
          ...
          (this.injectScript = function () {
            return (
              n._injectScriptPromise ||
                (n._injectScriptPromise = new Promise(function (t, e) {
                  var n = document.createElement("script");
                  (n.src =
                    "https://plugin.handtalk.me/analytics/1.0.0/ht-analytics.min.js"),
                    (n.onload = t),
                    (n.onerror = e),
          ...
          (this.processAttempQueue = function () {
            n.attempQueue.forEach(function (t) {
              n.ht.logger.info(t), n.sendEvent(t), n.attempQueue.shift();
            });
          }),
          (this.sendEvent = function (t) {
            return n.isInited && n.hasError
              ? void n.ht.logger.warn(
                  "AnalyticsAmanger: ignorando ação de track pois houve erro no carregamento"
                )
              : n.isInited && !n.isReady
              ? (n.ht.logger.info(
                  "AnalyticsManager: evento adicionado a fila de espera pois ainda não esta carregado"
                ),
                void n.attempQueue.push(t))
              : void (n.isInited
                  ? n.htAnalytics
                    ? n.htAnalytics.sendEvent(t)
                    : (n.ht.logger.info(
                        "AnalyticsAmanger: evento adicionado a fila de espera"
                      ),
                      n.attempQueue.push(t))
                  : n.ht.logger.info(
                      "AnalyticsManager: ignorando ação de track pois não houve init()"
                    ));
          }),
          (this.ht = e);
      };
        ...
        (r.default.HT.prototype.replaceYtEmbedAll = function () {
          ...
          this.logger.debug("players (youtube) encontrados", e),
            Array.prototype.forEach.call(e, function (e) {
              var n = e.src;
              n.match(l) &&
                !(0, s.isChildren)(e, "[data-ht-src]") &&
                t.replaceYtVideo(e, n);
            }),
          ...
          (r.default.HT.prototype.replaceYtEmbed = function (e) {
            ...
            n.match(l)
              ? t.replaceYtVideo(e, n)
              : this.logger.error(
                  "Falha ao efetuar replace de video | O elemento não é um embed do youtube"
                ),
              this.videoManager && this.videoManager.search();
          }),
      ...
      e.default = function (t) {
        (r.default.HT.prototype.replaceVideoJsAll = function () {
          ...
          (r.default.HT.prototype.replaceVideoJs = function (e) {
            try {
              e.ready(function () {
                this.signLanguageButton ||
                  (t.videoManager.makeVideojsAccessibile(this),
        ...
        (r.default.HT.prototype.replaceVimeoAll = function () {
          ...
          (r.default.HT.prototype.replaceVimeo = function (e) {
            ...
            n.match(l)
              ? t.replaceVimeoVideo(e, n)
              : this.logger.error(
                  "Falha ao efetuar replace de video | O elemento não é um embed do vimeo"
                ),
              this.videoManager && this.videoManager.search();
          }),
            ...
            o(this, t),
              ...
              (this.createSignLanguageButton = function () {
                (n.accessibleInSignLanguage = new h.default(n.ht)),
                  n.accessibleInSignLanguage.elem.classList.add(
                    M.accessibleInSignLanguage
                  ),
                  (n.accessibleInSignLanguage.elem.onclick = function () {
                    (n.ht.pageTranslatorManager.activated =
                      !n.ht.pageTranslatorManager.activated),
                      n.ht.pageTranslatorManager.activated
                        ? n.elem.classList.remove("ht-signlanguage-hover")
                        : n.hidePromptLink();
                  }),
                  (n.accessibleInSignLanguage.elem.onmouseenter = function () {
                    n.ht.pageTranslatorManager.activated ||
                      n.elem.classList.add("ht-signlanguage-hover");
                  }),
              ...
              (this.lockPageSpeechButton = function () {
                n.speechSynthesizerButton &&
                  n.speechSynthesizerButton.elem.classList.add("locked");
              }),
              (this.signWithHelperText = function (t) {
                return n.ht.hugo.then(function (e) {
                  var i = function () {
              ...
              (this.showSpeechTextDialog = function (t, e) {
                n.textDialog &&
                  (n._currentSpeechTextDialog &&
                    clearTimeout(n._currentSpeechTextDialog),
                  n.textDialog.show(t),
              ...
              (this.elem.innerHTML = (0, L.default)()),
              ...
              e.config.pageSpeech &&
                e.config.textEnabled &&
                this.elem.classList.add("ht-multi-accessibility"),
              ...
              (this.textDialog = new b.default(
                this.ht,
                "top" === this.ht.align ? "left-right" : "top"
              )),
              ...
              this.ht.on("errorOnAuth", function (t) {
                (n.loading.value = !1), n.showError(t);
              }),
              ...
              this.ht.on("translating", function () {
                (n._translatingCount += 1), (n.loading.value = 1 / 0);
              }),
              this.ht.on("customizing", function () {
                n.loading.value = 1 / 0;
              }),
              this.ht.on("customized", function () {
                (n.loading.value = !1), (n.splash.elem.style.display = "none");
              });
            var i = function () {
            ...
            r(t, [
              {
                ...
                value: function () {
                  ...
                  (this.speechSynthesizerButton = new d.default(this.ht)),
                    this.speechSynthesizerButton.elem.classList.add(
                      M.speechSynthesizerButton
                    ),
                    (this.speechSynthesizerButton.elem.onclick = function () {
                      (t.ht.pageSpeechManager.activated =
                        !t.ht.pageSpeechManager.activated),
                        t.elem.classList.toggle("ht-speech-active"),
                        A.default.body.classList.toggle("ht-speech-active"),
                        t.ht.pageSpeechManager.activated &&
                          t.elem.classList.remove("ht-speech-hover");
                    }),
                    (this.speechSynthesizerButton.elem.onmouseenter =
                      function () {
                        t.ht.pageSpeechManager.activated ||
                          t.elem.classList.add("ht-speech-hover");
                      }),
                    (this.speechSynthesizerButton.elem.onmouseleave =
                      function () {
                        t.ht.pageSpeechManager.activated ||
                          t.elem.classList.remove("ht-speech-hover");
                      }),
                  ...
                  (this._open = t),
                    this.open
                      ? (this.elem.classList.add("ht-signlanguage-active"),
                        this.ht.hugo
                          .then(function (t) {
                            t.resize(250, 400), e.mainElem.appendChild(t.elem);
                          })
                          .catch(function (t) {
                            (e.loading.value = !1),
                              e.ht.logger.error(t),
                              "string" == typeof t
                                ? e.showError(t)
                                : e.showError(
                                    "Ocorreu um erro ou seu navegador é incompatível. Aguarde um instante e recarregue a página."
                                  );
                          }))
      ...
      (e = t.exports = n(1)(void 0)),
        e.push([
          ...
          "@-webkit-keyframes leftToRight{0%{right:100px}to{right:-34px}}@keyframes leftToRight{0%{right:100px}to{right:-34px}}@-webkit-keyframes rightToLeft{0%{left:100px}to{left:-34px}}@keyframes rightToLeft{0%{left:100px}to{left:-34px}}@-webkit-keyframes leftToRightMobile{0%{right:100px}to{right:-38px}}@keyframes leftToRightMobile{0%{right:100px}to{right:-38px}}@-webkit-keyframes rightToLeftMobile{0%{left:100px}to{left:-38px}}@keyframes rightToLeftMobile{0%{left:100px}to{left:-38px}}._1I9gpmMU8FFFbLDIOZ2tr_{position:absolute;cursor:pointer;width:34px;height:34px;border:1px solid #ddd;background-color:#004b93;transition:height .6s ease;overflow:hidden;text-align:center}._1I9gpmMU8FFFbLDIOZ2tr_>.ht-icon{position:inherit;width:22px;height:22px;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%);transform:translate(-50%,-50%);z-index:1;background-image:url(" +
            ...
            n(8) +
            ");background-position:50%}.ht-speech-active>._1I9gpmMU8FFFbLDIOZ2tr_>.ht-text{display:none}",
          "",
        ]),
        (e.locals = { speechSynthesizerButton: "_1I9gpmMU8FFFbLDIOZ2tr_" });
    },
    function (t, e) {
      t.exports =
        ...
        h = (function () {
          function t(e) {
            o(this, t),
              ...
              (this.elem.innerHTML = (0, c.default)()),
              (this.determinateElem =
                this.elem.querySelector(".ht-ll-determinate")),
              (this.indeterminateElem = this.elem.querySelector(
                ".ht-ll-indeterminate"
              )),
              (this.value = !1);
          }
                  ...
                  (this._value = t),
                    "boolean" == typeof t && !1 === t
                      ...
                      : ((this.elem.style.display = "block"),
                        t === 1 / 0
                          ? ((this.determinateElem.style.display = "none"),
                            (this.indeterminateElem.style.display = "block"))
                          : ((this.indeterminateElem.style.display = "none"),
      ...
      var r = n(0),
        ...
        c = function t(e) {
          o(this, t),
            ...
            (this.ht = e),
            (this.elem = a.default.createElement("div")),
            (this.elem.innerHTML = (0, s.default)()),
    ...
    function (t, e, n) {
      function i(t) {
        var e = "";
        return (e +=
          '<div class="ht-sp-content"><div class="ht-sp-content-logo"></div><div class="ht-sp-content-text">Acessibilidade em Libras</div></div>');
      }
      n(3);
      t.exports = i;
    },
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        e.push([
          t.i,
          ".luz2GbqmNhNPsHYyJoT0U{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;width:100%;height:100%;background:#fff}.luz2GbqmNhNPsHYyJoT0U .ht-sp-content{width:70%}.luz2GbqmNhNPsHYyJoT0U .ht-sp-content-logo{width:100%;padding-bottom:28%;background-image:url(" +
            n(19) +
        ...
        (e.locals = { splash: "luz2GbqmNhNPsHYyJoT0U" });
    },
    function (t, e, n) {
      "use strict";
      function i(t, e) {
        ...
        A = function t(e) {
          ...
          i(this, t),
            ...
            (this.show = function (t) {
              if (!n.ht.textManager.activated) return !1;
              (n.contentElem.innerHTML = t), (n.elem.style.display = "block");
            }),
            (this.hide = function () {
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        ...
        (e.locals = { textDialog: "_2xkhEfnVcScwu6EaWxWMS8" });
    },
    function (t, e, n) {
      "use strict";
      function i(t) {
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        e.push([
          t.i,
          '._1_GJhjnCwusizoCnQ3QKZ7{position:relative;width:100%;height:100%;background-color:#fff}._1_GJhjnCwusizoCnQ3QKZ7:after{content:"";position:absolute;left:0;top:0;z-index:1;width:100%;height:100%;-webkit-filter:blur(3px);filter:blur(3px);opacity:.25;background-image:url(' +
            n(105) +
            ");background-size:contain;background-position:50%;background-repeat:no-repeat}._1_GJhjnCwusizoCnQ3QKZ7 .ht-es-header{margin:32px auto;text-align:center}._1_GJhjnCwusizoCnQ3QKZ7 .ht-es-header-logo{display:block;width:60%;margin:auto;padding-bottom:20%;background-image:url(" +
            n(19) +
            ");background-size:contain;background-repeat:no-repeat;background-position:50%}._1_GJhjnCwusizoCnQ3QKZ7 .ht-es-header-text{font-size:12px;line-height:1.2;color:#666;font-style:normal;font-weight:400;font-variant:normal;text-transform:none;text-decoration:none;font-family:Lato,sans-serif}._1_GJhjnCwusizoCnQ3QKZ7 .ht-es-attencion{margin:32px 0;padding-bottom:50%;background-image:url(" +
            n(106) +
        ...
        (e.locals = { errorSplash: "_1_GJhjnCwusizoCnQ3QKZ7" });
    },
    function (t, e) {
      t.exports =
    ...
    function (t, e, n) {
      function i(t) {
        var e = "";
        return (e +=
          '<div class="ht-es-header"><div class="ht-es-header-logo"></div><div class="ht-es-header-text">Tradutor de Sites para Libras</div></div><div class="ht-es-attencion"></div><div class="ht-es-text"></div>');
      }
      n(3);
      t.exports = i;
    },
          ...
          function t(e) {
            ...
            o(this, t),
              ...
              (this.showAt = function (t, e, i) {
                n.hasValidHrefContent(t)
                  ? (n.clearAttributes(n.a),
              ...
              (this.hasValidHrefContent = function (t) {
                if (!t.hasAttribute("href")) return !1;
              ...
              (this.cloneAttributes = function (t, e) {
                t.hasAttribute("href") &&
                  e.setAttribute("href", t.getAttribute("href")),
                  t.hasAttribute("target") &&
                    e.setAttribute("target", t.getAttribute("target"));
              }),
              (this.calculatePosition = function (e, i, o) {
                var r = i + t.targetMarginHorizontal + window.pageXOffset,
                  ...
                  c =
                    window.innerHeight + window.pageYOffset - s - t.marginBorder;
                (r = Math.min(r, l)),
                  (a = Math.min(a, c)),
                  (e.style.left = r + "px"),
                  (e.style.top = a + "px");
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        e.push([
          t.i,
          "._3Q4E6l7PtCF-ICONC1-lT_{position:absolute;box-sizing:content-box;width:36px;height:0;transition:height .8s ease;text-align:center;overflow:hidden}._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content{position:absolute;box-sizing:content-box;width:34px;height:180px;background-color:#004b93;text-align:center;border:1px solid #ddd}._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content>.ht-text{font-size:1em;position:absolute;bottom:0;left:0;z-index:0;width:34px;height:180px;background-image:url(" +
            n(9) +
            ");background-size:40%;background-repeat:no-repeat;background-position:50%}.ht-signlanguage-active ._3Q4E6l7PtCF-ICONC1-lT_,.ht-speech-active ._3Q4E6l7PtCF-ICONC1-lT_{display:none}:not(.ht-signlanguage-active).ht-button-animations.ht-left ._3Q4E6l7PtCF-ICONC1-lT_{right:100px;-webkit-animation:leftToRight .8s forwards;animation:leftToRight .8s forwards}:not(.ht-signlanguage-active).ht-button-animations.ht-right ._3Q4E6l7PtCF-ICONC1-lT_{left:100px;-webkit-animation:rightToLeft .8s forwards;animation:rightToLeft .8s forwards}:not(.ht-signlanguage-active).ht-multi-accessibility ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content{height:140px}:not(.ht-signlanguage-active).ht-multi-accessibility ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content>.ht-text{height:140px;background-image:url(" +
            n(24) +
            ")}:not(.ht-signlanguage-active).ht-multi-accessibility:not(.ht-speech-hover):not(.ht-signlanguage-hover).ht-force-hover ._3Q4E6l7PtCF-ICONC1-lT_{height:142px}:not(.ht-signlanguage-active).ht-multi-accessibility:not(.ht-speech-hover):not(.ht-signlanguage-hover).ht-force-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content{height:140px}:not(.ht-signlanguage-active).ht-multi-accessibility:not(.ht-speech-hover):not(.ht-signlanguage-hover).ht-force-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content>.ht-text{height:140px;background-image:url(" +
            n(24) +
            ")}:not(.ht-signlanguage-active).ht-speech-hover ._3Q4E6l7PtCF-ICONC1-lT_{height:142px}:not(.ht-signlanguage-active).ht-speech-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content{height:140px}:not(.ht-signlanguage-active).ht-speech-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content>.ht-text{height:140px;background-image:url(" +
            n(117) +
            ")}:not(.ht-signlanguage-active).ht-signlanguage-hover ._3Q4E6l7PtCF-ICONC1-lT_{height:182px}:not(.ht-signlanguage-active).ht-signlanguage-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content{height:180px}:not(.ht-signlanguage-active).ht-signlanguage-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content>.ht-text{height:180px;background-image:url(" +
            n(118) +
            ");background-size:45%}:not(.ht-signlanguage-active):not(.ht-multi-accessibility).ht-signlanguage-hover ._3Q4E6l7PtCF-ICONC1-lT_{height:182px}:not(.ht-signlanguage-active):not(.ht-multi-accessibility).ht-signlanguage-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content{height:180px}:not(.ht-signlanguage-active):not(.ht-multi-accessibility).ht-signlanguage-hover ._3Q4E6l7PtCF-ICONC1-lT_>.ht-tl-content>.ht-text{height:180px;background-image:url(" +
            n(9) +
    ...
    function (t, e, n) {
              ...
              o(this, t),
                ...
                (this.applyCustomButtonStyle = function (t) {
                  ...
                  t.borderRadius && (e.style.borderRadius = t.borderRadius),
                    ...
                    t.horizontalMargin &&
                      ("right" === n.ht.config.side
                        ? (e.style.right = t.horizontalMargin)
                        : (e.style.left = t.horizontalMargin)),
                    t.bottomMargin && (e.style.bottom = t.bottomMargin);
                }),
                (this.createSwipeDetector = function () {
                  var t = function (t) {
                    ("left" !== t && "right" !== t) ||
                      ((n.side = t), A.default.set("ht-preferred-side", t));
                  };
                  (0, u.swipeDetect)(n.swipeDetectorElem, t),
                    (0, u.swipeDetect)(n.accessibleInSignLanguage.elem, t);
                }),
                (this.createSignLanguageButton = function () {
                  (n.accessibleInSignLanguage = new f.default(n.ht)),
                    n.accessibleInSignLanguage.elem.classList.add(
                      k.accessibleInSignLanguage
                    ),
                    (n.accessibleInSignLanguage.elem.onclick = function () {
                      n.ht.pageTranslatorManager.activated =
                        !n.ht.pageTranslatorManager.activated;
                    }),
                    n.ht.config.customButtonStyle ||
                      (n.elem.classList.add("ht-button-animations"),
                      setTimeout(function () {
                        n.elem.classList.remove("ht-button-animations");
                      }, 3e3),
                      setTimeout(function () {
                ...
                (this.resize = function () {
                  (n._width = 0),
                    (n._height = 0),
                    h.default.innerWidth < h.default.innerHeight
                      ? ((n._width = t.potraitScaleFactor * h.default.innerWidth),
                        (n._height = t.potraitAspectRatio * n._width))
                      : ((n._height =
                          t.landscapeScaleFactor * h.default.innerHeight),
                        (n._width = t.landscapeAspectRatio * n._height)),
                    (n._width > t.maxWidth || n._height > t.maxHeight) &&
                      ((n._width = t.maxWidth), (n._height = t.maxHeight)),
                ...
                this.elem.classList.add("ht-skip"),
                (this.elem.innerHTML = (0, T.default)()),
                (this.elem.style.zIndex = this.ht.config.zIndex),
                (this.elem.style.bottom = this.ht.config.bottom),
                "top" === e.config.actionsAlign &&
                  this.elem.classList.add("ht-md-actions-top"),
                (this.mainElem = this.elem.querySelector(".ht-md-main")),
                (this.swipeDetectorElem = this.elem.querySelector(
                  ".ht-md-swipe-detector"
                )),
                ...
                this.mainElem.appendChild(this.loading.elem),
                (this.loadingSpin = this.elem.querySelector(
                  ".ht-md-loading-spin"
                )),
                e.config.textEnabled && this.createSignLanguageButton(),
                e.config.customButtonStyle
                  ? this.applyCustomButtonStyle(e.config.customButtonStyle)
                  : this.createSwipeDetector(),
                ...
                this.ht.on("errorOnAuth", function (t) {
                  (n.loadingSpin.style.display = "none"), n.showError(t);
                }),
                this.ht.on("hugoDownloadDependenciesProgress", function (t) {
                  n.loading.value = t / 2;
                }),
      ...
      (L.maxWidth = 250),
        ...
        (L.potraitScaleFactor = 0.5),
        (L.landscapeScaleFactor = 0.8),
        (e.default = L);
    },
    function (t, e, n) {
      "use strict";
            ...
            r(t, [
              {
                key: "value",
                set: function (t) {
                  (this._value = t), (this.loaderElem.style.height = t + "%");
                },
              },
            ]),
            t
    ...
    function (t, e, n) {
      (e = t.exports = n(1)(void 0)),
        e.push([
          t.i,
          "._11i5YaA0CiwArVZPMDsiYz{position:relative;background-image:url(" +
            n(128) +
            ");background-position:bottom;background-size:100% 100%;bottom:0;width:100%;height:100%}._11i5YaA0CiwArVZPMDsiYz .ht-hl-loader{position:absolute;background-image:url(" +
            n(129) +
            ");background-position:bottom;background-size:100%;bottom:0;width:100%;height:0%;z-index:10}",
          "",
        ]),
        (e.locals = { hugoLoading: "_11i5YaA0CiwArVZPMDsiYz" });
    },
    function (t, e) {
      t.exports =
